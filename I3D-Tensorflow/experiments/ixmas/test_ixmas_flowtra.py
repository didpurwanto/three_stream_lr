...
import input_test_trajf as input_test
import math
import numpy as np
...
def run_training():
    ...
    pre_model_save_dir = "./models/flowt_imagenet_3000_6_64_0.0001_decay_split1"
    test_list_file = '../../list/ixmas_list/testlist_2_tra.list'
    output_path = 'prediction_trajflow_ixmas'
    ...
    for step in xrange(all_steps):
        ...
        while True:
	        ...
	        tmpp = file[step].split("/")
		namefile = tmpp[6].split(" ") 
		namefile = namefile[0]
		data["prediction"] = avg_pre
		data["label"] = int(val_labels)+1
		sio.savemat(output_path + '/' + namefile + '.mat',data, do_compression = False)
                break
