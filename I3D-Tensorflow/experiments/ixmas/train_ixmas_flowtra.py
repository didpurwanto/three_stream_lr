...
import input_data_abu as input_data
import math
import numpy as np
...
FLAGS = flags.FLAGS
model_save_dir = './models/flowt_imagenet_3000_6_64_0.0001_decay_split1'
...
def run_training():
    ...
    train_writer = tf.summary.FileWriter('./visual_logs/train_flowt_imagenet_3000_6_64_0.0001_decay_split2', sess.graph)
    test_writer = tf.summary.FileWriter('./visual_logs/test_flowt_imagenet_3000_6_64_0.0001_decay_split2', sess.graph)
    for step in xrange(FLAGS.max_steps):
        start_time = time.time()
        rgb_train_images, flow_train_images, train_labels, _, _, _ = input_data.read_clip_and_label(
                      filename='../../list/ixmas_list/trainlist_2_tra.list',
        ...
        if step % 10 == 0 or (step + 1) == FLAGS.max_steps:
            ...
            rgb_val_images, flow_val_images, val_labels, _, _, _ = input_data.read_clip_and_label(
                            filename='../../list/ixmas_list/testlist_2_tra.list',
                            batch_size=FLAGS.batch_size * gpu_num,
                            num_frames_per_clip=FLAGS.num_frame_per_clib,
                            crop_size=FLAGS.crop_size,
                            shuffle=True
