...
FLAGS = flags.FLAGS
model_save_dir = './models/trajabu_scratch_20000_6_64_0.0001_decay_split1'
...
def run_training():
    ...
    train_writer = tf.summary.FileWriter('./visual_logs/trainabu_tra_scratch_20000_6_64_0.0001_decay_split1', sess.graph)
    test_writer = tf.summary.FileWriter('./visual_logs/testabu_tra_scratch_20000_6_64_0.0001_decay_split1', sess.graph)
