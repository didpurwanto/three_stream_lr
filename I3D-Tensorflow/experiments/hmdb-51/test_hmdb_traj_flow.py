...
def run_training():
    ...
    pre_model_save_dir = "./models/trajabu_scratch_20000_6_64_0.0001_decay_split1"
    test_list_file = '../../list/hmdb_list/testlist1_tra.list'
    output_path = 'prediction_trajflow'
