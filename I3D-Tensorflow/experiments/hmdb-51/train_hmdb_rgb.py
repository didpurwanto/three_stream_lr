...
FLAGS = flags.FLAGS
model_save_dir = './models/rgb_imagenet_10000_6_64_0.0001_decay_split1'
...
def run_training():
    ...
    train_writer = tf.summary.FileWriter('./visual_logs/train_rgb_imagenet_10000_6_64_0.0001_decay_split1', sess.graph)
    test_writer = tf.summary.FileWriter('./visual_logs/test_rgb_imagenet_10000_6_64_0.0001_decay_split1', sess.graph)
